    ...
    return (
      <Host>
        <button onClick={() => this.handleClick()}>
          ...
          { document.documentElement.lang.toLowerCase()==='fa-ir'? <span style={{fontFamily:"IRANSans"}}>{state.localization.AddFolder}</span>:<span>{state.localization.AddFolder}</span>}
