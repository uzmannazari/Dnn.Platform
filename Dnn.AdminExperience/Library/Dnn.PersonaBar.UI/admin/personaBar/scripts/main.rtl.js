    ...
    function ($, ko, moment, ut, sf, cf, extension, persistent, eventEmitter, iconLoader, Gateway) {
        ...
        var util = {
            ...
            closePersonaBar: function handleClosePersonarBar(callback, keepSelection) {
                ...
                $activePanel.animate({ right: -860 }, 189, 'linear', function () {//persian-dnnsoftware
                    $('.socialpanel').css({ right: -860 }).hide();//persian-dnnsoftware
                    $mask.animate({
                        opacity: 0.0
                    }, 200, function () {
            ...
            loadPanel: function handleLoadPanel(identifier, params) {
                ...
                if ($mask.css("display") === 'none') {
                    ...
                    $mask.animate({
                        ...
                        $panel.show().delay(100).animate({ right: personaBarMenuWidth }, 189, 'linear', function () {//persian-dnnsoftware
                            inAnimation = false;
                    ...
                    if (activePath !== path) {
                        ...
                        $activePanel.fadeOut("fast", function handleHideCurrentPanel() {
                            $panel.css({ right: personaBarMenuWidth }).fadeIn("fast", function handleShowSelectedPanel() {//persian-dnnsoftware
